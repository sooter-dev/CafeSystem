...
* The original package name 'sooter-dev.cafe.system' is invalid and this project uses 'sooter_dev.cafe.system' instead.
...
* [ElevenLabs](https://docs.spring.io/spring-ai/reference/api/speech/elevenlabs-speech.html)
